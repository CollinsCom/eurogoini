        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Biodigestor</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt">Biodigestor</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='biodigestor.php'">Beneficios</br></span>
                 <!-- <span class="TextList" onclick="location.href='calentador_carc.php'">Características</br></span> -->
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/manuales/GuiaBiodig-Jul09.pdf')">Manual</br></span>
                 <!-- <span class="TextList" onclick="window.open('/eurogoini/archivos/tablasResist/.pdf')">Tabla de resistencias</br></span> -->
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/saneamientogob2009.pdf')">Ficha técnica</br></span>
                 <!-- <span class="TextList" onclick="location.href=''">Video</br></span> -->
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/garantias/certificado_biodigestor.pdf')">Garantía  y certificados</br></span></div>
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img_biodigestor2.png" style="margin-top:0px;"/> 
              <div align="left">
                <p class="Titulo">
                  Solución inteligente a la falta de drenaje
                </p>         
              
                <ul class="linea">
                  <li>Sustituye la fosa séptica.</li>
                  <li>Evita la contaminación de mantos freáticos y del medio ambiente.</li>
                  <li>No genera malos olores.</li>
                  <li>Evita los costos de mantenimiento al ser autolimpiable (se desazolva abriendo una llave).</li>
                  <li>Fácil y rápido de instalar.</li>
                  <li>Cumple con la norma NOM-006-CNA-1997, (fosas sépticas prefabricadas, especificaciones y métodos de prueba).</li>
</ul>
              </div>
