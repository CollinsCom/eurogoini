        ...
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="15"> </tr>
            ...
            <td align="center" rowspan="2">
              ...
              <div align="left">
                <p class="Titulo">
                  Ideal para mantener una presión constante en la red hidráulica de toda la obra
                </p>         
              
                <ul class="linea">
                  <li>Mejora la presión en la red hidráulica.</li>
                  <li>Bajo consumo eléctrico.</li>
                  <li>Funcionamiento silencioso.</li>
                  <li>Disponible 3/4 1, 1.2 HP.</li>
