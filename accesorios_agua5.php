        ...
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="15"> </tr>
            ...
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img-acceflotador.png"/> 
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
                ...
                <ul class="linea">
                  <li>Evita que el agua rebase el nivel óptimo, permitiendo un llenado personalizado.</li>
                  <li>Material de fabricación: polipropileno de alta densidad grado soplo.</li>
                  <li>Para trabajar en alta y baja presión #3 baño, #5 tinaco, #7 cisterna.</li>
</ul>
              </div>
