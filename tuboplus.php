      ...
      <tr>
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="50"> </tr>
            ...
            <div class="divMenu" onclick="location.href='Tuboplus/tpsanitario.php'" style="margin-right: 130px;">
              <span class="titMenu"> <span class="cap">Tuboplus</span> tubería sanitaria</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img-tuboplus_sanitario.png"/>
            </div>    

            <div class="divMenu" onclick="location.href='Tuboplus/tphidraul.php'">
              <span class="titMenu"><span class="cap">Tuboplus</span> tubería hidráulica</span>
