        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Baño Bio</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt">Baño Bio</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='banobio.php'">Beneficios</br></span>
                 <span class="TextList" onclick="location.href='banobio_carc.php'">Características</br></span>
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/manuales/guiabanodigno.pdf')">Manual</br></span>
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img-banobio.png" style="margin-top: -20px;"/>
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
