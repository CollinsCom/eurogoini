        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Calentador</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt">Calentador</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='calentador.php'">Beneficios</br></span>
                 <!-- <span class="TextList" onclick="location.href='calentador_carc.php'">Características</br></span> -->
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/manuales/guiaCSA.pdf')">Manual</br></span>
                 <!-- <span class="TextList" onclick="window.open('/eurogoini/archivos/tablasResist/.pdf')">Tabla de resistencias</br></span> -->
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/Cercsolar.pdf')">Ficha técnica</br></span>
                 <span class="TextList" onclick="window.open('http://www.youtube.com/watch?v=OfwYtVG9AHQ&lr=1', '_blank')">Video</br></span>
                 <!-- <span class="TextList" onclick="window.open('/eurogoini/archivos/garantias/.jpg')">Garantía  y certificados</br></span></div> -->
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img-calentador.png" style="margin-top: -30px;" /> 
              <div align="left">
                <p class="Titulo">
                  Innovación tecnológica a favor de nuestro planeta
                </p>         
              
                <ul class="linea">
                  <li>Ahorra hasta el 70% del consumo de gas.</li>
                  <li>Panel solar de alta resistencia a impactos (300 kg/m²).</li>
                  <li>Termotanque de acero porcelanizado de 150 litros suficiente para abastecer a 5 personas de agua caliente.</li>
                  <li>Resiste altas presiones.</li>
                  <li>Cumple con la norma DIT / 149 / 10.</li>
</ul>
              </div>
