      ...
      <tr>
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="50"> </tr>
            ...
            <div class="divMenu" onclick="location.href='gobierno/mejoramiento_gob.php'">
              <span class="titMenu"><span class="cap">M</span>EJORAMIENTO</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img_biodigestor2.png"/>
            </div>

            <div class="divMenu" onclick="location.href='gobierno/conduccion_agua.php'">
            ...
            <div class="divMenu" onclick="location.href='gobierno/almacenamiento.php'">
