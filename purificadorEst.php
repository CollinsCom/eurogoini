        ...
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="15"> </tr>
            ...
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/filtroEstandar.png" style="margin-top: -40px; width:500px;" /> 
              <div align="left">
                <p class="Titulo">
                  Filtro Estándar
                </p>         
                ...
                <ul class="linea">
                  <li>Ideal para zonas con alta concentración de sedimentos.</li>
                  <li>Retiene el 99% de sedimentos, tierra y  partículas mayores a 50 micras.</li>
                  <li>Asegura agua de calidad en la red hidráulica.</li>
                  <li>Evita que se tapen regaderas y tuberías.</li>
                  <li>Ideal para tinaco rotoplas. Filtra 24 litros por minuto.</li>
