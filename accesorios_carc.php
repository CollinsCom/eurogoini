        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Accesorios</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt">Accesorios</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='accesorios.php'">Beneficios</br></span>
                 <span class="TextList" onclick="location.href='accesorios_carc.php'">Características</br></span>
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/Flyer_Accesorios_ y_Tanques.pdf')">Ficha técnica</br></span>
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/accesorios.png" style="margin-top:30px;"/> 
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
                ...
                <ul class="linea">
                  <li>Fabricados de una sola pieza.</li> 
                  <li>Material rígido y ligero.</li>                   
