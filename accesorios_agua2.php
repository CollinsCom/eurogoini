        ...
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="15"> </tr>
            ...
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img-accemulticonector.png"/> 
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
                ...
                <ul class="linea">
                  <li>Diseño exclusivo, sustituye 8 piezas necesarias para la instalación.</li>
                  <li>Permite la limpieza y lavado del tinaco.</li>
                  <li>Material de fabricación: polipropileno.</li>
                  <li>Medida de conexión para tinaco: 1” ½”.</li>
                  <li>Medida de conexión para tubería: 1” y ¾.</li>
</ul>
              </div>
