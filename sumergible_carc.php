        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;BOMBA SUMERGIBLE</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt" style="font-size:16px;">BOMBA SUMERGIBLE</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='sumergible.php'">Beneficios</br></span>
                 <span class="TextList" onclick="location.href='sumergible_carc.php'">Características</br></span>
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/manuales/Sumergible1.pdf')">Manual</br></span>
            ...
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/bomba-sumergible.png" style="margin-top:0px"/> 
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
