          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
              ...
              <div align="left">
                ...
                <!-- <span class="TextList" onclick="window.open('/eurogoini/archivos/garantia s/certificadobombaperiferica.jpg')">Garantía  y certificados</br></span> -->
               </div>
            </td>
            <td align="center" rowspan="2">
              ...
              <div align="left">
                ...
                <ul class="linea">
                  <li>Fabricado en polipropileno.</li>
                  <li>Reforzado con tecnología tricapa.</li>
                  <li>Exclusivo sistema de unión mediante su anillo de doble labio.</li>
                  <li>Capa exterior con aditivo que protege a la tubería de rayos UV.</li>
                  <li>Gama completa de tubería y conexiones de 40 mm (1 1/2") a 160 mm (6") en el mayor surtido de México.</li>
                  <li>Alta resistencia a impactos y agentes químicos.</li>
