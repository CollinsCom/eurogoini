        ...
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="15"> </tr>
            ...
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/bajotarja.png" style="margin-top: -40px; width:500px;" /> 
              <div align="left">
                <p class="Titulo">
                  Filtro Bajo Tarja
                </p>         
                ...
                <ul class="linea">
                  <li>Retiene el 99% de bacterias causantes de enfermedades gastrointestinales.</li>
                  ...
                  <li>Bajo costo de mantenimiento. Se recomienda cambiar el cartucho entre 3 y 6 meses dependiendo su frecuencia de uso (repuestos disponibles).</li>
                  <li>1 cartucho = 2,400 litros de agua pura  = 6 meses de garrafones = 5 garrafones x semana.</li>
                  <li>Te da hasta el 86% de ahorro requeridos por hipoteca verde.</li>
</ul>
              </div>
