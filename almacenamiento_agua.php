      ...
      <tr>
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="50"> </tr>
            ...
            <div class="divMenu" onclick="location.href='almacenamiento_de_agua/tinaco.php'">
              <span class="titMenu"><span class="cap">T</span>INACO EQUIPADO</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img_tinaco2.png"/>
            </div>
            <div class="divMenu" onclick="location.href='almacenamiento_de_agua/cisterna.php'">
              <span class="titMenu"><span class="cap">C</span>ISTERNA EQUIPADA</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img-cisternaGd2.png"/>
            </div>
            <div class="divMenu" onclick="location.href='almacenamiento_de_agua/accesorios_agua.php'">
              <span class="titMenu"><span class="cap">A</span>CCESORIOS</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img-accemulticonector.png"/>
            </div>     
            </td>
          </tr>
          </table>
