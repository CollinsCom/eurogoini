      ...
      <tr>
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="50"> </tr>
            ...
            <div class="divMenu" onclick="location.href='mejoramiento_y_ahorro/sistemaduo.php'">
              <span class="titMenu"><span class="cap">S</span>ISTEMA DUO</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/sistemaDuo_B.png"/>
            </div>
            <div class="divMenu" onclick="location.href='mejoramiento_y_ahorro/purificador.php'">
              <span class="titMenu"><span class="cap">P</span>URIFICADORES</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/sobretarja.png"/>
            </div> 
            <div class="divMenu" onclick="location.href='mejoramiento_y_ahorro/calentador.php'">
              <span class="titMenu"><span class="cap">C</span>ALENTADOR SOLAR</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img-calentador.png"/>
            </div> 
            <div class="divMenu" onclick="location.href='mejoramiento_y_ahorro/biodigestor.php'" style="margin-right:230px">
              <span class="titMenu"><span class="cap">B</span>IODIGESTOR</span>
