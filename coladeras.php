        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Coladeras</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt">Coladeras</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='coladeras.php'">Beneficios</br></span>
                 <span class="TextList" onclick="location.href='coladeras_carc.php'">Características</br></span>
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/registro.pdf')">Ficha técnica</br></span>
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/Coladera.png"/> 
              <div align="left">
                <p class="Titulo">
                ...
                <ul class="linea">
                  <li>Tienen alta resistencia a impactos.</li>
                  <li>Recubrimiento exterior UV lo que asegura mayor tiempo de vida.</li>
                  <li>Rejillas ajustables a la losa.</li>
                  <li>Coladera altamente versátil ya que se puede ajustar a la orientación de la instalación hidráulica.</li>
                  <li>Garantía CERO FUGAS y seguridad en las uniónes.</li>
                  <li>Disponibles: coladera de baño, (rejilla de plástico y metal) coladera de azotea y de patio.</li>
