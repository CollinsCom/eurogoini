        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Tolvas</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt">Tolvas</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='tolvas.php'">Beneficios</br></span>
                 <!-- <span class="TextList" onclick="location.href='tolvas_carc.php'">Características</br></span> -->
                 ...
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/tolvas.pdf')">Ficha técnica</br></span>
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img-tagro.png"/> 
              <div align="left">
                <p class="Titulo">
                ...
                <ul class="linea">
                  ...
                  <li>Fondo cónico que permite vaciado total y dosificación de productos.</li>
                  <li>Grado alimenticio (certificado por la FDA).</li>
                  <li>Almacenamiento de agua, alimentos y más de 300 sustancias químicas.</li>
</ul>
              </div>
