          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
              ...
              <div align="left"> 
                <span class="TextList" onclick="location.href='tphidraul.php'">Beneficios</br></span>
                 ...
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/manueales/manualhidraulica.pdf')">Manual</br></span>
            ...
            <td align="center" rowspan="2">
              ...
              <div align="left">
                ...
                <ul class="linea">
                  <li>Capa exterior ultravioleta.</li>
                  <li>Fabricado en polipropileno copolymer random.</li>
                  <li>Amplia disponibilidad y surtido en 20 mm (1/2) a 110 mm (4").</li>
                  <li>Sistema de unión por termofusión.</li>
                  <li>Alta resistencia a impactos.</li>
                  <li>Resistencia a altas presiones 20 kg /cm3.</li>
                  <li>Resistencia a temperaturas extremas desde el punto de congelacion hasta 95°C.</li>
