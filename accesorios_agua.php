          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
              ...
              <div align="left"> 
                 ...
                 <div style="margin-top: 5px; margin-bottom: 5px;"><div style="margin-top: 5px; margin-bottom: 5px;"><span class="TextList" onclick="location.href='accesorios_agua2.php'" style="line-height: 15px;" >Multiconector con válvula de esfera y tuerca unión</br></span></div></div>
            ...
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img-accevalvula.png"/> 
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
                ...
                <ul class="linea">                  
                  <li>Permite un tinaco eficiente y rápido suministro de agua que garantiza el correcto llenado de tu cisterna y tinacos.</li>
                  <li>Partes metálicas: acero inoxidable y bronce.</li>
                </ul>
              </div>
