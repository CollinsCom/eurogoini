        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Cisterna equipada</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt" style="font-size: 16px;">Cisterna equipada</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='cisterna.php'">Beneficios</br></span>
                 <span class="TextList" onclick="location.href='cisterna_carc.php'">Características</br></span>
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/manuales/garantía cisterna.pdf')">Manual</br></span>
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/capa_cisterna.pdf')">Ficha técnica</br></span>
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/garantias/30MarzoGarantia_Cisterna2012.pdf')">Garantía y certificados</br></span></div>
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" style="margin-top: -35px;" src="/eurogoini/ima/menus/img-cisternaGd2.png"/> 
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
                ...
                <ul class="linea">
                  <li>Equipada con el exclusivo filtro HydroNet el cual retiene tierra y sedimentos, evita que se tapen las tuberías brindando agua limpia y cristalina.</li>
                  <li>Su exclusiva capa antibacterial (tecnología Expel), inhibe la reproducción de bacterias.</li>
                  <li>Equipada con accesorios rotoplas que garantizan cero fugas.</li>
                </ul>
              </div>
