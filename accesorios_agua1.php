        ...
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="15"> </tr>
            ...
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/pichancha.png"/> 
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
                ...
                <ul class="linea">
                  <li>Mantiene un flujo de agua sin interrupciones.</li>
                  <li>Desaloja el aire contenido en las líneas de agua para trabajar en baja y alta presión (de 2kg.0/cm 2 hasta 14kg/cm 2).</li>
