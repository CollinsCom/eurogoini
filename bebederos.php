        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Bebederos y Comedores</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt" style="font-size:16px;">Bebederos y Comedores</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='bebederos.php'">Beneficios</br></span>
                 <!-- <span class="TextList" onclick="location.href='bebederos_carc.php'">Características.</br></span> -->
                 ...
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/bebederos.pdf')">Ficha técnica</br></span>
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img-bebederos.png"/> 
              <div align="left">
                <p class="Titulo">
                ...
                <ul class="linea">
                  <li>No tiene ángulos rectos internos que evitan la generacion de bacterias.</li>
                  <li>Grado alimenticio (certificado por FDA).</li>
                  <li>Muy ligeros y fáciles de transportar.</li>
                  <li>No requieren de estructura para fijación.</li>
</ul>
              </div>
