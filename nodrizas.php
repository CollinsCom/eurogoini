        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Nodrizas</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt">Nodrizas</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='nodrizas.php'">Beneficios</br></span>
                 <!-- <span class="TextList" onclick="location.href='nodrizas_carc.php'">Características</br></span> -->
                 ...
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/tanques_nodriza.pdf')">Ficha técnica</br></span>
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img-noagro.png"/> 
              <div align="left">
                <p class="Titulo">
                  Material de alta densidad estándar, reforzamiento del 20% y 40% dependiendo la sustancia
                </p>         
              
                <ul class="linea">                    
                  <li>Cuenta con sistema de rompeolas.</li>
                  <li>Adaptación práctica a cualquier remolque.</li>
                  <li>Para transporte de sustancias como:</li>
                    <ul class="sec">
                      <li>Agua.</li>
                      <li>Fertilizantes.</li>
                      <li>Más de 300 sustancias químicas.</li>
                    </ul>
                </ul>
              </div>
