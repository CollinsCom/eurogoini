        ...
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="15"> </tr>
            ...
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/Valvula_esfera.png"/> 
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
                ...
                <ul class="linea">
                  <li>Mantiene presión en el agua y proporciona un mejor caudal.</li>
                  <li>Material de fabricación: polipropileno para trabajar en baja y alta presión (de 0.2kg/cm hasta 14kg/cm).</li>
