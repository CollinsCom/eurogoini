        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Tanques de almacenamiento</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt">Tanques de almacenamiento</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='tanques.php'">Beneficios</br></span>
                 <!-- <span class="TextList" onclick="location.href='tanques_carc.php'">Características</br></span> -->
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/tablasResist/resistencias_quimicas.pdf')">Tabla de resistencias</br></span>
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/tab_tanques.pdf')">Ficha técnica</br></span>
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img-tVertagro.png"/> 
              <div align="left">
                <p class="Titulo">
                ...
                <ul class="linea">
                  <li>Material de alta densidad estándar, reforzamiento del 20% y 40% dependiendo la sustancia.</li> 
                  <li>Ideales para almacenar agua, picmentos, pulpas, licores y más de 300 sustancias químicas como ácidos, cloruros y fosfatos.</li>
                  <li>No se oxidan ni se corroen.</li>
                  <li>No requieren mantenimiento.</li>
                  <li>Fabricados con HDPE, 100% virgen, de una sola pieza.</li>
