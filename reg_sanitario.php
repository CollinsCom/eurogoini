        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Registro sanitario</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt" style="font-size:16px;">Registro sanitario</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='reg_sanitario.php'">Beneficios</br></span>
                <!-- <span class="TextList" onclick="location.href='reg_sanitario_carc.php'">Características</br></span> -->
            ...
            <!--<span class="TextList" onclick="window.open('/eurogoini/archivos/tablasResist/.pdf')">Tabla de resistencias</br></span>-->
                <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/registro.pdf')">Ficha técnica</br></span>
            <!--<span class="TextList" onclick="window.open('/eurogoini/archivos/garantias/.jpg')">Garantía  y certificados</br></span></div> -->
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/registro-sani.png" style="margin-top:-35px;"/> 
              <div align="left">
                <p class="Titulo">
                  Fabricación en polietileno de alta densidad
                </p>         
              
                <ul class="linea">
                  <li>No tiene filtraciones.</li>
                  <li>Cuenta con una pendiente para facilitar el flujo hidráulico.</li>
                  <li>No se corroe, resiste químicos y limpiadores comunes.</li>
                  <li>Ahorro en tiempo y costos de instalación.</li>
                  <li>Compatible con el servicio público de alcantarillado (4" 6") y tuberías de distintos diámetros.</li>
                  <li>Disponible con tapa ciega o tapa con coladera.</li>
                  <li>Alta resistencia a impactos, principalmente al ser instalado en la obra.</li>
