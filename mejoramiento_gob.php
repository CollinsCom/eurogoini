      ...
      <tr>
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="50"> </tr>
            ...
            <div class="divMenu" onclick="location.href='mejoramiento/alm_pluvial.php'">
              <span class="titMenu" STYLE="font-size:14px;" ><span class="cap">A</span>LMACENAMIENTO PLUVIAL</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img-almacenamiento.png"/>
            </div>  

              <div class="divMenu" onclick="location.href='mejoramiento/biodigestor.php'">
              <span class="titMenu"><span class="cap">B</span>IODIGESTOR</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img_biodigestor2.png"/>
            </div>  

              <div class="divMenu" onclick="location.href='mejoramiento/banobio.php'">
              <span class="titMenu"><span class="cap">B</span>año digno</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img-banoDigno01.png"/>
            </div>        
            </td>
          </tr>
          </table>
