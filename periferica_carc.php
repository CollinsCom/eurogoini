        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;Bomba periférica</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt" style="font-size:16px;">Bomba periférica</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='periferica.php'">Beneficios</br></span>
                 <span class="TextList" onclick="location.href='periferica_carc.php'">Características</br></span>
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/manuales/peri2cp.pdf')" onclick="window.open('/eurogoini/archivos/manuales/peri4cp.pdf')">Manual</br></span>
                 ...
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/garantias/certperiferica.pdf')">Garantía  y certificados</br></span></div>
            </td>
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/bomba-periferica.png" style="margin-top:0px"/> 
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
                ...
                <ul class="linea">
                  <li>Gran calidad y larga duración de sus componentes.</li>
                  <li>Protección térmica para evitar daños por calentamiento.</li>
                  <li>Motor con bajo nivel de ruido y totalmente sellado para instalación en interperie.</li>
</ul>
              </div>
