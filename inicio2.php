      ...
      <tr>
        <td height="120" align="left" valign="bottom">
          ...
          <tr height="50"> </tr>
            ...
            <div class="divMenu" onclick="location.href=''">
              <span class="titMenu">          GOBIERNO          </span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img_tinaco2.png"/>
            </div>
            <div class="divMenu" onclick="location.href=''">
              <span class="titMenu">CONSTRUCCIÓN</span>
              <img class="imgMenu" src="/eurogoini/ima/menus/img-cisternaGd2.png"/>
            </div>
            
            <div class="divMenu" onclick="location.href='agroindustrias.php'">
