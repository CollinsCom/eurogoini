        ...
        <td height="120" align="left" valign="bottom">
          ...
          <table align="center" width="700" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
              <td>
                ...
                <span style="float:right;"><p class="TituloArt">&nbsp;&nbsp;SISTEMA DE CAPTACION</br> ALMACENAMIENTO PLUVIAL</p></span>
              </td>
            </tr>                
          ...
          <tr height="15"> </tr>
            <td align="center" valign="top">             
               <span><p class="TituloArt" STYLE="FONT-SIZE:14PX;" >&nbsp;&nbsp;SISTEMA DE CAPTACION</br> ALMACENAMIENTO PLUVIAL</p></span>
               <img src="/eurogoini/ima/linea.jpg" height="3" width="190"/>  

              <div align="left"> 
                <span class="TextList" onclick="location.href='alm_pluvial.php'">Beneficios</br></span>
                 <span class="TextList" onclick="location.href='alm_pluvial_carc.php'">Características</br></span>
                 ...
                 <span class="TextList" onclick="window.open('/eurogoini/archivos/fichasTec/almacenamiento_gobierno.pdf')">Ficha técnica</br></span>
            ...
            <td align="center" rowspan="2">
              <img class="imgArt" src="/eurogoini/ima/menus/img-almacenamiento.png" style="margin-top:-10px; width:200px;" /> 
              <div align="left">
                <p class="Titulo">
                  Características
                </p>         
